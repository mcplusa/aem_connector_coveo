...
public final class MimeTypes {
    public enum Application {
        ...
        MP4("application/mp4"), OCTET_STREAM("application/octet-stream"), PDF("application/pdf"),
        PKCS_10("application/pkcs10"), PKCS_7_MIME("application/pkcs7-mime"),
        PKCS_7_SIGNATURE("application/pkcs7-signature"), PKCS_8("application/pkcs8"),
        POSTSCRIPT("application/postscript"), RDF_XML("application/rdf+xml"), RSS_XML("application/rss+xml"),
        RTF("application/rtf"), SMIL_XML("application/smil+xml"), X_FONT_OTF("application/x-font-otf"),
        X_FONT_TTF("application/x-font-ttf"), X_FONT_WOFF("application/x-font-woff"), X_PKCS_12("application/x-pkcs12"),
